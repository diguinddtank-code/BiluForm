...
const BookingForm: React.FC<BookingFormProps> = ({ language }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await fetch("https://webhook.infra-remakingautomacoes.cloud/webhook/fbusa", {
        method: "POST",
        headers: { 
          ...
          >
              <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 relative">
                ...
                <div className="bg-gray-50 p-6 sm:p-10 text-center relative overflow-hidden border-b border-gray-100">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-black font-display text-bisa-navy uppercase tracking-tight leading-none mb-2">{t.successTitle}</h2>
                    <p className="text-gray-500 text-[10px] sm:text-xs uppercase tracking-widest font-bold">{t.receipt}</p>
                </div>

                <div className="px-4 sm:px-8 pb-8 sm:pb-12 pt-6 sm:pt-8 text-center">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 sm:p-8 border border-gray-200 relative mt-4">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <div className="flex items-center justify-center space-x-2 sm:space-x-4 bg-white px-4 py-3 sm:px-6 sm:py-4 rounded-lg border border-gray-200 w-full shadow-sm">
                                ...
                                <button 
                                    ...
                                    title="Copy"
                                >
                                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                                </button>
                            </div>
                    ...
                    <button 
                        ...
                        className="mt-6 sm:mt-8 w-full bg-[#25D366] text-white py-3 sm:py-4 px-4 rounded-xl font-bold text-xs sm:text-sm uppercase tracking-widest hover:bg-[#20bd5a] transition-colors flex items-center justify-center gap-2 sm:gap-3 shadow-md"
                    >
                        <svg className="w-4 h-4 sm:w-5 sm:h-5 shrink-0" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex flex-col lg:flex-row w-full min-h-[800px]">
        ...
        <div className="p-8 md:p-16 lg:p-24 flex-1 flex flex-col justify-center">
          ...
          >
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 flex flex-col items-center md:items-start">
